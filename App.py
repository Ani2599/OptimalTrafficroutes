...
st.markdown('Shuttle service Graph')
...
if uploaded_file is not None:     
    ...
    df = G.loc[G.groupby(['Road']).Distance.idxmin()]
    ...
    st.write("Best Route: ", df[["Origin_code", "Dest_code",'Road']])
    st.write("Shortest Path: ", nx.shortest_path(g))
